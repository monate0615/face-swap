...
from multi_threading.modules import cmd_args, errors
from multi_threading.modules.paths_internal import script_path, extensions_dir
from multi_threading.modules.timer import startup_timer
from multi_threading.modules import logging_config
...
def check_python_version():
    ...
    if not (major == 3 and minor in supported_minors):
        import multi_threading.modules.errors

        multi_threading.modules.errors.print_error_explanation(f"""
